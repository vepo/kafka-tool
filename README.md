...
* **Windows installer** — MSI built on GitHub when a `v*` tag is pushed; use **Actions → Prepare release → Run workflow** while `pom.xml` is a `-SNAPSHOT` version (e.g. `0.0.3-SNAPSHOT` → releases `0.0.3`, then bumps to `0.1.0-SNAPSHOT`)

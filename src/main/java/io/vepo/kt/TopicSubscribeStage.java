...
public class TopicSubscribeStage extends JFrame { //extends Stage {
...
//    private KafkaBroker settings;
//    private String topic;
//
//    public TopicSubscribeStage(String topic, Stage owner, KafkaBroker settings) {

...
import io.vepo.kt.KafkaMessage;
...
public interface KafkaAgnosticConsumer {
    ...
    class StringKafkaAgnosticConsumer implements KafkaAgnosticConsumer {
        private AtomicBoolean running;

        public StringKafkaAgnosticConsumer() {
            running = new AtomicBoolean(false);
        }
    ...
    static KafkaAgnosticConsumer plainText() {
        return new StringKafkaAgnosticConsumer();
    }
